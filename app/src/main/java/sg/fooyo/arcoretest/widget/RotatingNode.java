 ...
 */
package sg.fooyo.arcoretest.widget;
...
public class RotatingNode extends Node {
  ...
  private long getAnimationDuration() {
    return (long) (1000 * 360 / (degreesPerSecond *1f));
  }
  ...
  private static ObjectAnimator createAnimator() {
    ...
    Quaternion orientation1 = Quaternion.axisAngle(new Vector3(0.0f, 0.0f, 1.0f), 0);
    Quaternion orientation2 = Quaternion.axisAngle(new Vector3(0.0f, 0.0f, 1.0f), 120);
    Quaternion orientation3 = Quaternion.axisAngle(new Vector3(0.0f, 0.0f, 1.0f), 240);
    Quaternion orientation4 = Quaternion.axisAngle(new Vector3(0.0f, 0.0f, 1.0f), 360);
